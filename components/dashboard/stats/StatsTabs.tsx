...
import { LayoutGrid, Users, FileStack, LayoutDashboard, Calendar, ChevronDown, FileText, BarChart3 } from 'lucide-react';
...
const StatsTabs: React.FC<StatsTabsProps> = ({ stats, loading, activeTab, onTabChange }) => {
  ...
  const tabs = [
    ...(isAdmin || isSuperAdmin ? [{ id: 'global', label: 'Vue d\'ensemble', icon: LayoutGrid }] : []),
    { id: 'users', label: 'Salariés', icon: Users },
    { id: 'types', label: 'Analyse', icon: BarChart3 },
    ...
    <div className="space-y-6 w-full max-w-full">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center gap-3 w-full lg:w-auto">
          ...
          {/* Filtre de Date - Masqué en mode Analyse (qui a son propre filtre) */}
          {internalTab !== 'types' && (
            <>
