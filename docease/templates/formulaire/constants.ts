...
export const TEMPLATE_SPECIFIC_FIELDS: Record<string, FormField[]> = {
  designation: [
    ...
    { id: 'civiliteDelegue', label: 'Civilité Délégué(e) Nommé(e)', type: 'select', options: ['Monsieur', 'Madame'], required: true, width: 'third' },
    { id: 'nomDelegue', label: 'Nom Délégué(e) Nommé(e)', type: 'text', placeholder: 'Ex: Martin Dupont', required: true, icon: 'person', width: 'third' },
    { id: 'emailDelegue', label: 'Email Délégué(e) Nommé(e)', type: 'email', placeholder: 'delegue@exemple.com', required: true, icon: 'email', width: 'third' },
  ...
  negociation: [
    { id: 'objet', label: 'Objet du Mandat', type: 'text', placeholder: 'Ex: Négociation accord temps de travail', required: true, icon: 'subject', width: 'half' },
    { id: 'civiliteDelegue', label: 'Civilité du Mandataire', type: 'select', options: ['Monsieur', 'Madame'], required: true, width: 'third' },
    { id: 'nomDelegue', label: 'Nom du Mandataire', type: 'text', placeholder: 'Ex: Jean Durand', required: true, icon: 'person', width: 'third' },
    { id: 'emailDelegue', label: 'Email du Mandataire', type: 'email', placeholder: 'mandataire@exemple.com', required: true, icon: 'email', width: 'third' },
  ],
  convocations: [
  ...
  // Champs CA Fédérale - 1er jour (numéro document + ordres du jour 1-4)
  convocations_ca_federale_jour1: [
    { id: 'codeDocument', label: 'Numéro du document', type: 'text', placeholder: 'Ex : DOC-2024-001', required: true, icon: 'description', width: 'full', forceUppercase: true },
    { id: 'ordreDuJour1', label: 'Point 1', type: 'text', placeholder: 'Premier point à l\'ordre du jour', required: true, icon: 'list', width: 'half' },
    { id: 'ordreDuJour2', label: 'Point 2', type: 'text', placeholder: 'Deuxième point à l\'ordre du jour', required: false, icon: 'list', width: 'half' },
    { id: 'ordreDuJour3', label: 'Point 3', type: 'text', placeholder: 'Troisième point à l\'ordre du jour', required: false, icon: 'list', width: 'half' },
    { id: 'ordreDuJour4', label: 'Point 4', type: 'text', placeholder: 'Quatrième point à l\'ordre du jour', required: false, icon: 'list', width: 'half' },
  ],
  // Champs CA Fédérale - 2ème jour (ordres du jour 5-8 + signature)
  convocations_ca_federale_jour2: [
    { id: 'ordreDuJour5', label: 'Point 1', type: 'text', placeholder: 'Premier point du 2ème jour', required: false, icon: 'list', width: 'half' },
  ...
  // Champs Bureau Fédéral - Ordre du jour (numéro document + points 1-4 + signature)
  convocations_bureau_federal_ordre_du_jour: [
    { id: 'codeDocument', label: 'Numéro du document', type: 'text', placeholder: 'Ex : DOC-2024-001', required: true, icon: 'description', width: 'full', forceUppercase: true },
    { id: 'ordreDuJour1', label: 'Point 1', type: 'text', placeholder: 'Premier point à l\'ordre du jour', required: true, icon: 'format_list_numbered', width: 'half' },
